...
# the best parameters are C = 0.1 and gamma = 1 and degree = 3 for 16
# C = 1, degree = 2, and gamma = 1 for 32
...
model2 = svm.SVC(C=1, gamma=1, degree=2, kernel='poly', probability=True)
